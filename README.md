...
## 📊 Project Overview
Developed an end-to-end data science pipeline to analyse 1.2M+ rows of London smart meter data. Built a system to identify consumption anomalies and forecast future demand.
...
- **Time-Series Forecasting:** Utilised Facebook Prophet to model complex residential seasonality and 7-day future demand.
